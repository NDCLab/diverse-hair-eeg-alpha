...
#SBATCH --job-name=SFEmatjob        	# job name
...
matlab -nodisplay -r "cd('/home/data/NDClab/analyses/diverse-hair-eeg-alpha/code/sfe_processing/postprocessing/erp'); run('create_mat_s1.m'); exit"
